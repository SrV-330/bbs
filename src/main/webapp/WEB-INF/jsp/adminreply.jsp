...
$.ajax({
			...
			type:"POST",
			url:"/bbs/post/postdetail/reply/undel",
			async:false,
			dataType:"json",
...
<div class="container-fluid">
	...
	<div class="container">
		<ul class="nav nav-pills">
		  ...
		  <li class="active"><a href="#">被删的回复</a></li>
        ...
        <c:forEach var="ps" items="${ps}" varStatus="st">
            <tr>
                ...
                <td><button type="button" class="btn btn-link btn-rmp"><input type="hidden" value="${ps.pid }"><span>恢复</span></button></td>
